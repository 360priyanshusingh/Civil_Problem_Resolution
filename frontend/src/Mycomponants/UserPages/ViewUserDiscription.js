...
function ViewUserDiscription() {
    const location = useLocation();
    const { dis,title } =  location.state ? location.state : { dis: "",title:""};
  ...
  return (
    <div className="loginbody loginmargin"style={{display:"flex" ,justifyContent:"center",backgroundColor:"lightcoral" ,minHeight:"90vh" }} >
     <div className="logincontainer"style={{margin:"30px"}} >
      <div className="title">View Problem Discription</div>
...
export default ViewUserDiscription