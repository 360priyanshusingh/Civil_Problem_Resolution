...
function UpdateInProgessStatus() {
    ...
    const handleSubmit = async(event) => {
		...
		axios.put(`http://localhost:5000/admin/updateProblem2/${userId}`,{status:"Problem Solved",estimateDate}).
		then((result)=>{
			console.log(result)
      ...
      <div className="content">
        <form >
          <div className="user-details">
            ...
            <div className="input-box"  style={{width:"100%"}} >
              <span className="details" ><h4>Problem Completion Date</h4></span>
...
export default UpdateInProgessStatus