...
function ViewNotStartedProblem() {
...
/>          
    ...
    <Thead>
      <Tr>
        ...
        <Th style={{ fontSize:"15px" }} >Start Work Know</Th>
      </Tr>
    </Thead>
    <Tbody>
     { user? (user.map((u)=>(
     ...
     <Td>{u.postDate}
         ...
         <Td>{u.status}</Td>
         <Td> <Button onClick={() => handleClick(u._id,u.title)} > Start Work On That Problem </Button> </Td>
...
export default ViewNotStartedProblem